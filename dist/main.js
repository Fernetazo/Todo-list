...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n\n\nconst firstLoad = () => {\n    \n    class Project {\n        constructor(title, description) {\n            this.title = title;\n            this.description = description;\n            this.TODOlist = [];\n        }\n    };\n\n    class singleTODO {\n        constructor(priority, checked, title, dueDate, details) {\n            this.priority = priority;\n            this.checked = checked;\n            this.title = title;\n            this.dueDate = dueDate;\n            this.details = details;\n        }\n    };\n\n    let date = Date();\n\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.mainTODOlist.push(new singleTODO('High', true,'Do the dishes', date,'Remember to use the sponge!'));\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.mainTODOlist.push(new singleTODO('Medium', false,'Wash the car', date));\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.mainTODOlist.push(new singleTODO('Low', true,'Pet the cat', date,'Miau'));\n\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects.push(new Project('Vacation', 'Going to Rome!'));\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects.push(new Project('Buy new car', 'I like the white one'));\n    \n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects[0].TODOlist.push(new singleTODO('Medium', true,'Buy tickets', date,'Should buy on despegar.com'));\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects[0].TODOlist.push(new singleTODO('High', true,'Check prices]', date,'Check on google flights'));\n\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects[1].TODOlist.push(new singleTODO('High', true,'Check model T', date,'I really want a Tesla'));\n    _index_js__WEBPACK_IMPORTED_MODULE_0__.projects[1].TODOlist.push(new singleTODO('Low', true,'Buy the goddam car', date,'Oh yeah!'));\n\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (firstLoad);\n\n//# sourceURL=webpack://todo-list/./src/firstLoad.js?");
